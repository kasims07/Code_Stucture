...
import 'package:gfive/api_client/api_constans.dart';
                    ...
                    body: Container(
                      ...
                      child: Padding(padding: EdgeInsets.only(
                          ...
                          child: Column(
                            children: [
                              Text('Logout',
                                style: AppStyles.homelogostyle.copyWith(
                                    fontSize: 20.sp),),
                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, AppScreens.editProfile);
                            },
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, AppScreens.termsAndConditions);
                        },
                        child: CustomAccountRow(
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, AppScreens.privacyPolicy);
                        },
                        child: CustomAccountRow(
                          text: 'Privacy Policy',
                      ...
                      Padding(padding: EdgeInsets.only(
                          right: 20.65, left: 20.sp),
                        child:
                        InkWell(
                          onTap: () {
                            AccountScreen.logoutpopup(context: context);
                          },
                          child: Row(

                            children: [
                              SvgPicture.asset(
                                  ImageAssetPath.login, height: 20.h,
                                  width: 20.w),
