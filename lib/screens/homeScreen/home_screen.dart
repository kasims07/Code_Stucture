...
class _HomeScreenState extends State<HomeScreen> {
  ...
  builder: (context, state) {
    return Stack(
        children: [
         state.isLoading ? LoadingContainer() : Container(
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 15),
                  Text('Hello ${state.model!.user!.name}', style: AppStyles.redstyle),
                  SizedBox(height: 5),
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                    ...
                                    child: Text('${state.model!.data!.first.category}',style: AppStyles.homelogostyle ,))
                              ],
                            ),
                          ),
                        ),
